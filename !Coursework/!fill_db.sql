...
INSERT INTO sub_storages (storage_id, owner_id, name) VALUES
    ...
    (12, 4, 'Полка-3'),
    (12, 4, 'Полка-4'),
    (12, 4, 'Нижнее отделение'),
    (13, 4, 'Отделение слева'),
    (13, 4, 'Отделение справа'),
    (13, 4, 'Откр. полка-1'),
    (13, 4, 'Откр. полка-2'),
    (14, 4, 'Полка-1'),
    (14, 4, 'Полка-2'),
    (14, 4, 'Полка-3'),
    (14, 4, 'Полка-4'),
    (14, 4, 'Нижнее отделение'),
    (15, 4, 'Верхняя полка справа'),
    (15, 4, 'Штанга для одежды'),
    (15, 4, 'Нижнее отделение справа-снизу'),
    (15, 4, 'Полка-1 слева'),
    (15, 4, 'Полка-2 слева'),
    (15, 4, 'Полка-3 слева'),
    (15, 4, 'Полка-4 слева'),
    ...
    (16, 4, 'Полка-3'),
    (16, 4, 'Полка-4'),
    (16, 4, 'Нижнее отделение'),
    (17, 4, 'Открытая полка-1'),
    (17, 4, 'Открытая полка-2'),
    (17, 4, 'Открытая полка-3'),
    (17, 4, 'Открытая полка-4'),
    (17, 4, 'Выдв. ящик-1'),
    (17, 4, 'Выдв. ящик-2'),
    (19, 5, 'Выдв. ящик-1'),
    (19, 5, 'Выдв. ящик-2'),
    ...
    (22, 1, 'Откр. полка-2'),
    (22, 1, 'Выдв. ящик'),
    (22, 1, 'Нижн. отделение, полка-1'),
    (22, 1, 'Нижн. отделение, полка-2'),
    (23, 1, 'Выдв. ящик слева'),
    (23, 1, 'Выдв. ящик справа'),
    (24, 1, 'Полка-1 слева'),
    (24, 1, 'Полка-2 слева'),
    (24, 1, 'Полка-3 слева'),
    (24, 1, 'Полка-4 слева'),
    ...
    (27, 1, 'Полка-3 слева'),
    (27, 1, 'Полка-4 слева'),
    (27, 1, 'Штанга для одежды'),
    (27, 1, 'Место внизу под штангой'),
    (28, 1, 'Верх. полка над штангой'),
    (28, 1, 'Штанга для одежды'),
    (28, 1, 'Место внизу под штангой'),
    (28, 3, 'Полка-1 справа'),
    (28, 1, 'Полка-2 справа'),
    (28, 1, 'Полка-3 справа'),
    (28, 1, 'Полка-4 справа'),
    ...
    (33, 1, 'Полка-2'),
    (34, 1, 'Верхняя полка'),
    (34, 1, 'Основное отделение'),
    (35, 1, 'Верхняя полка'),
    (36, 1, 'Основное отделение');
...
INSERT INTO cat_sizes (alias, rus_size, int_size) VALUES
    ...
    ('ЖенОджд-XL', '50', 'XL'),
    ('ЖенОджд-XXL', '52', 'XXL'),
    ('ЖенОджд-XXXL', '54', 'XXXL'),
    ('ЖенОджд-BXL', '56', 'BXL'),
    ('ЖенОджд-BXXL', '58', 'BXXL'),
